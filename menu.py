...
class Menu(QtWidgets.QMainWindow, Ui_MainWindow):# nobre de la clase como tal seiempre igual
    def __init__(self):#metodo constructor 
        ...
        self.w3_1 =Registre_vuelo()
        self.w3_2=Finaliza_vue()
        ...
        self.btn_gestioneTa.clicked.connect((partial(self.adminitra_vuelo,self.w3_1,self.w3_2)))     
    ...
    def adminitra_emples(self,window):
        window.show()    
    def adminitra_vuelo(self,window,window1):
        window.show()      
        window1.show()
